...
accordionBtns.forEach((accordion) => {
  accordion.onclick = function () {
    ...
    let content = this.closest("h2").nextElementSibling; 
    ...
    if (content.style.maxHeight) {
      ...
      // FIX #2: if the accordion was open, now it will be closed, so set aria-expanded to false
      ...
      //FIX #3: if the accordion was closed, now it will be open, so set aria-expanded to true
